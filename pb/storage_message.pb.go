...
type Storage struct {
	...
	Driver Storage_Drive `protobuf:"varint,1,opt,name=driver,proto3,enum=Storage_Drive" json:"driver,omitempty"`
...
func (x *Storage) GetDriver() Storage_Drive {
	if x != nil {
		return x.Driver
	}
...
var file_proto_storage_message_proto_rawDesc = []byte{
	...
	,
...
var file_proto_storage_message_proto_goTypes = []interface{}{
	(Storage_Drive)(0), // 0: Storage.Drive
	(*Storage)(nil),    // 1: Storage
	(*Memory)(nil),     // 2: Memory
}
var file_proto_storage_message_proto_depIdxs = []int32{
	0, // 0: Storage.driver:type_name -> Storage.Drive
